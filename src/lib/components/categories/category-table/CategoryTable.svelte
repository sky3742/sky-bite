						...
						<td class="px-6 py-4">
							<div class="flex items-center gap-2">
								<button
									...
									class:bg-primary-600={category.isActive}
									class:bg-gray-300={!category.isActive}
								>
									<span
										class="inline-block h-4 w-4 rounded-full bg-white shadow-sm transition"
										class:translate-x-[1.125rem]={category.isActive}
										class:translate-x-[2px]={!category.isActive}
									></span>
								</button>
								<button
